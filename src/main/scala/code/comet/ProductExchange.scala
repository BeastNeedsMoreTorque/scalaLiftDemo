...
 * A singleton that provides Product publication/exchange features to all clients.
...
   * We send a ProductMessage, which is immutable type,
...
    */
  override def lowPriority = {
      // use partial function for the callback to our publisher ProductExchange,
